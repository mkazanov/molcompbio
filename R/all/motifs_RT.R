...
OUTPUT_DIR <- "/Users/mar/BIO/PROJECTS/APOBEC/Project1_TranscriptionLevel/ResultsFinalRall/RTmotifs"
...
for(c in 1:nrow(cancers)){
  ...
  for(i in 1:nrow(samples)){
    ...
    p <- ggplot(dtSampleMotifs, aes(x=Motif,y=Coef)) + geom_bar(stat="identity",
      ...
      ylab("Slope of mutation density distribution over replication timing") +
